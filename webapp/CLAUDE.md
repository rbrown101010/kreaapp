...
<environment>
  ...
  You can see logs in the vite.log file or browser console.
...
<state>
  ...
  Never wrap the root App component directly with extra providers.
...
<components>
  shadcn/ui components are in src/components/ui/. Use them extensively:

  <forms>
    Input, Textarea, Select, Checkbox, RadioGroup, Switch, Label, Slider
    Use react-hook-form with zod for form validation.
  </forms>

  <feedback>
    Dialog, AlertDialog, Sheet, Drawer, Toast (sonner), Tooltip, Popover
  </feedback>

  <data_display>
    Table, Card, Accordion, Tabs, Badge, Avatar, Progress, Skeleton
  </data_display>
  ...
  <layout>
    ScrollArea, Separator, Collapsible, ResizablePanelGroup, Sidebar
  </layout>

  <special>
    Command (cmdk for command palette), Calendar, Chart (recharts)
  </special>
</components>
